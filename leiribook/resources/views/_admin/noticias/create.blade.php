...
<div class="au-breadcrumb-left">
    ...
    <ul class="list-unstyled list-inline au-breadcrumb__list">
        ...
        <li class="list-inline-item active">
            <a href="{{ route('admin.noticias.create') }}">Criar</a>
        </li>
    </ul>
</div>
<button onclick="location.href='{{ route('admin.noticias.index') }}'" class="au-btn au-btn-icon au-btn--green">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="{{ route('admin.noticias.store',$noticia) }}" method="post" enctype="multipart/form-data">
                            @csrf
